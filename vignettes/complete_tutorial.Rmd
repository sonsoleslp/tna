...
plot(cliques_of_two, vsize = 15, edge.label.cex = 2, esize = 20, ask = F)
```
...
Centrality_stability <- estimate_centrality_stability(model, detailed = FALSE, iter = 100)
