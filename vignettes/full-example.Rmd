...
<!-- TODO remove clustering for now -->
---
# # Clustering
# 
# Initialization
...
# tna_model_clus2 <- pruned_clus$pruned
# ```
# 
# Plotting the cluster transitions after pruning
# ```{r, fig.width=10, fig.height=3.2, message = F}
# layout(t(1:3))
# 
# plot(tna_model_clus2, cluster = 1, edge.label.cex = 2, vsize = 18, 
#      title = clusternames[1], title.cex = 1.15)
# plot(tna_model_clus2, cluster = 2, edge.label.cex = 2, vsize = 18, 
#      title = clusternames[2], title.cex = 1.15)
# plot(tna_model_clus2, cluster = 3, edge.label.cex = 2, vsize = 18, 
#      title = clusternames[3], title.cex = 1.15)
# ```
# 
# 
