...
Performs clustering using specified dissimilarity measures and
clustering methods. The rows of the data are first converted to strings
...
- dissimilarity:
  ...
  available options are: `"osa"`, `"lv"`, `"dl"`, `"hamming"`, `"lcs"`,
