...
```
```{r tnaplot, echo = FALSE,  results = "asis"}
cat('<center>')
plot(tna_model, cut = 0.3)
cat('</center>')
```
...
```{r, fig.width=12, fig.height=8, out.width="90%", eval = F}
plot(cent, ncol = 3)
```

```{r centralitiesplot, fig.width=12, fig.height=8, out.width="90%", echo = F, results = 'asis'}
cat('<center>')
plot(cent, ncol = 3)
cat('</center>')
```
