...
<!--
```{css, echo = FALSE}
body > img, body > table, div > img, div > table {
    display: block;
    margin: auto;
}
```
...
```{r centralitiesplot, fig.width=12, fig.height=8, out.width="90%", imgcenter=TRUE}
plot(cent, ncol = 3)
```
...
```{r, out.width="100%", fig.width=6, fig.height=2, echo = F, imgcenter=TRUE}
layout(t(1:3))
cqs <- cliques(tna_model, threshold = 0.12)
...
```{r, fig.width=10, fig.height=5, out.width="100%", echo = 2:3, imgcenter=TRUE}
layout(t(1:2))
